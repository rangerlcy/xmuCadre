...
public class SecondmentController {
		...
		public String SuperSearchUserList(Integer currPage,SecondmentParam secondmentParam,Model model, String PaperNumber,
					String PaperTitle, String PaperUnit,String temporaryProjectName,String temporaryBeginDay,String temporaryEndDate,String temporaryRequirement) throws Exception{
			//secondmentParam.toString()
			//System.out.println("!!!~~~~~"+PaperNumber);
			secondmentParam.setPostingNumber(PaperNumber);
			secondmentParam.setPostingTitle(PaperTitle);
			secondmentParam.setPostingUnit(PaperUnit);
			secondmentParam.setTemporaryProjectName(temporaryProjectName);
			secondmentParam.setTemporaryBeginDay(temporaryBeginDay);
			secondmentParam.setTemporaryEndDate(temporaryEndDate);
			secondmentParam.setTemporaryRequirement(temporaryRequirement);
		...
		public String secondmentDetail(Integer id,Model model) throws Exception{	
			try {
				...
				Paper paper = paperService.findById(secondmentresult.getPaper().getId());
				if (null == paper){
					model.addAttribute("errMsg", "无此详细信息");
					return ViewLocation.FOLDER_MSGCOMMON+"/fail";
				}
...
//				}
		        ...
		        DictionaryItem e = new DictionaryItem("02", "发文文号"); 
		        titleList.add(e);
		         e = new DictionaryItem("03", "发文题目"); 
		        titleList.add(e);
		         e = new DictionaryItem("04", "发文单位"); 
		        titleList.add(e);
		         e = new DictionaryItem("05", "挂职项目名称"); 
		        titleList.add(e);
		         e = new DictionaryItem("06", "挂职开始时间"); 
		        titleList.add(e);
		         e = new DictionaryItem("07", "挂职结束时间"); 
		        titleList.add(e);
		         e = new DictionaryItem("08", "挂职人员要求"); 
		        titleList.add(e);
		         e = new DictionaryItem("09", "备注"); 
		        titleList.add(e);
		        int n = 0;
				...
				try {
					...
					logger.error("导出挂职信息错误:" + ee.getMessage());
					throw new Exception("导出挂职信息错误:" + ee.getMessage());
				} finally {
					try {
						if (bis != null)   
			                bis.close();   
