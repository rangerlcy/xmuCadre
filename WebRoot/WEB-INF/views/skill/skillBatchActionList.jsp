...
<html>
  ...
  <body class="ny_body">
		...
		<form id="uploadAddForm"
			action="${ctx}/skill/importSkill.do"
		...
		<div class="r_help_box r_help_box2">
			<p><span style="color:red; font-weight:bold;">批量导入须知</span></p>
			<p>1、上传您制作好的名单（excel格式）。按照[姓名]、[证件号码]、[起始时间]、[结束时间]、[聘任级别]、[专业技术职务]、[核对情况]、[备注]的顺序，<span style="color:red; font-weight:bold;">其中[姓名]为必填,其余选填,请按要求规范填写</span></p>
			<p>
				2、核对情况包括:<br/>
				已核对无误、待核对
			</p>
		...
		<div style="padding:10px 20px">
			参考范例：<a href="${ctx }/resources/Template/import-skill.xlsx"
				class="blue">下载表格模板</a>
		</div>
		</div>
