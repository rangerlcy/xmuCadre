...
<body class="ny_body">
	<div style="padding:0 20px">
		...
		<form id="uploadDelForm"
			action="/xmuCadre/userTrain/quantityAction/importDelUserTrainInfo.do"
			method="post" enctype="multipart/form-data">
			<div class="r_search">
				<input id="uploadDelFile" type="file" name="file"
					class="upload_file_excel" /> <input id="uploadDelBtn"
	...
	<script type="text/javascript">
		$(function() {
			bindUploadDelBtnEvent();//绑定上传按钮事件
